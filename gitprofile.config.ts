    ...
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: ['fsiddiqi03/fsiddiqi03', 'fsiddiqi03/portfolio', 'fsiddiqi03/Personal-Portfolio', 'fsiddiqi03/AdvancedCV'], // These projects will not be displayed. example: ['arifszn/my-project1', 'arifszn/my-project2']
        },
      },
      manual: {
